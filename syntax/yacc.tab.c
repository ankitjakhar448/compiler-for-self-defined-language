...
static const yytype_uint8 yyrline[] =
{
      ...
      94,    99,   102,   103,   106,   107,   108,   111,   114,   117,
     120,   123,   124,   125,   126,   127,   128,   129,   130,   133,
     136,   139,   140,   143,   144,   145,   146,   149,   152,   153,
     154,   155,   158,   159,   160,   161,   162,   163,   164,   165,
     166,   169,   172,   175,   176,   177,   178,   179,   180,   183,
     184,   185,   186,   187,   190,   191,   192,   193,   196,   197,
     200,   201,   202,   203,   204
};
#endif
...
/* Line 1792 of yacc.c  */
#line 81 "yacc.y"
    {printf("program -> global_var program\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 83 "yacc.y"
    {printf("program -> assignment program\n");}
    break;

  case 5:
/* Line 1792 of yacc.c  */
#line 84 "yacc.y"
    {printf("program -> global_var\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 86 "yacc.y"
    {printf("program -> assignment\n");}
    break;

  case 8:
/* Line 1792 of yacc.c  */
#line 90 "yacc.y"
    {printf("function -> function_def function\n");}
    break;

  case 9:
/* Line 1792 of yacc.c  */
#line 91 "yacc.y"
    {printf("function -> function_def\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 99 "yacc.y"
    {printf("fun_id -> IDENTIFIER\n");}
    break;

  case 12:
/* Line 1792 of yacc.c  */
#line 102 "yacc.y"
    {printf("return_list -> data_type COMMA return_list\n");}
    break;

  case 13:
/* Line 1792 of yacc.c  */
#line 103 "yacc.y"
    {printf("return_list -> data_type\n");}
    break;

  case 14:
/* Line 1792 of yacc.c  */
#line 106 "yacc.y"
    {printf("param_list -> data_type IDENTIFIER COMMA param_list\n");}
    break;

  case 15:
/* Line 1792 of yacc.c  */
#line 107 "yacc.y"
    {printf("param_list -> data_type IDENTIFIER\n");}
    break;

  case 17:
/* Line 1792 of yacc.c  */
#line 111 "yacc.y"
    {printf("global_var -> var_declareation\n");}
    break;

  case 18:
/* Line 1792 of yacc.c  */
#line 114 "yacc.y"
    {printf("blocks -> start_black block end_block\n");}
    break;

  case 19:
/* Line 1792 of yacc.c  */
#line 117 "yacc.y"
    {printf("start_black -> LEFT_CURLY_BRACKET\n");}
    break;

  case 20:
/* Line 1792 of yacc.c  */
#line 120 "yacc.y"
    {printf("end_block -> RIGHT_CURLY_BRACKET\n");}
    break;

  case 21:
/* Line 1792 of yacc.c  */
#line 123 "yacc.y"
    {printf("block -> var_declareation block\n");}
    break;

  case 22:
/* Line 1792 of yacc.c  */
#line 124 "yacc.y"
    {printf("block -> var_declareation\n");}
    break;

  case 23:
/* Line 1792 of yacc.c  */
#line 125 "yacc.y"
    {printf("block -> assignment block\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 133 "yacc.y"
    {printf("print -> printst exp SAMI_COLON\n");}
    break;

  case 30:
/* Line 1792 of yacc.c  */
#line 136 "yacc.y"
    {printf("printst -> PRINT\n");}
    break;

  case 31:
/* Line 1792 of yacc.c  */
#line 139 "yacc.y"
    {printf("var_declareation -> data_type variables SAMI_COLON var_declareation\n");}
    break;

  case 32:
/* Line 1792 of yacc.c  */
#line 140 "yacc.y"
    {printf("var_declareation -> data_type variables SAMI_COLON\n");}
    break;

  case 33:
/* Line 1792 of yacc.c  */
#line 143 "yacc.y"
    {printf("variables -> var_id COMMA variables\n");}
    break;

  case 34:
/* Line 1792 of yacc.c  */
#line 144 "yacc.y"
    {printf("variables -> var_id\n");}
    break;

  case 35:
/* Line 1792 of yacc.c  */
#line 145 "yacc.y"
    {printf("variables -> var_id EQUEL exp	COMMA variables\n");}
    break;

  case 36:
/* Line 1792 of yacc.c  */
#line 146 "yacc.y"
    {printf("variables -> var_id EQUEL exp\n");}
    break;

  case 37:
/* Line 1792 of yacc.c  */
#line 149 "yacc.y"
    {printf("var_id -> IDENTIFIER\n");}
    break;

  case 38:
/* Line 1792 of yacc.c  */
#line 152 "yacc.y"
    {printf("data_type -> INT_KEY\n");}
    break;

  case 39:
/* Line 1792 of yacc.c  */
#line 153 "yacc.y"
    {printf("data_type -> REAL_KEY\n");}
    break;

  case 40:
/* Line 1792 of yacc.c  */
#line 154 "yacc.y"
    {printf("data_type -> STRING_KEY\n");}
    break;

  case 41:
/* Line 1792 of yacc.c  */
#line 155 "yacc.y"
    {printf("data_type -> CHAR_KEY\n");}
    break;

  case 42:
/* Line 1792 of yacc.c  */
#line 158 "yacc.y"
    {printf("assignment -> assign_id EQUEL	exp SAMI_COLON\n");}
    break;

  case 43:
/* Line 1792 of yacc.c  */
#line 159 "yacc.y"
    {printf("assignment -> eqassign_id PLUS_AND_EQUEL exp	SAMI_COLON\n");}
    break;

  case 44:
/* Line 1792 of yacc.c  */
#line 160 "yacc.y"
    {printf("assignment -> eqassign_id MINUS_AND_EQUEL exp SAMI_COLON\n");}
    break;

  case 45:
/* Line 1792 of yacc.c  */
#line 161 "yacc.y"
    {printf("assignment -> eqassign_id	MULTIPLY_AND_EQUEL	exp	SAMI_COLON\n");}
    break;

  case 46:
/* Line 1792 of yacc.c  */
#line 162 "yacc.y"
    {printf("assignment -> eqassign_id	DEVIDE_AND_EQUEL exp SAMI_COLON	\n");}
    break;

  case 47:
/* Line 1792 of yacc.c  */
#line 163 "yacc.y"
    {printf("assignment -> eqassign_id  MODULES_AND_EQUEL exp SAMI_COLON\n");}
    break;

  case 48:
/* Line 1792 of yacc.c  */
#line 164 "yacc.y"
    {printf("assignment -> eqassign_id	AND_AND_EQUEL	exp	SAMI_COLON\n");}
    break;

  case 49:
/* Line 1792 of yacc.c  */
#line 165 "yacc.y"
    {printf("assignment -> eqassign_id	OR_AND_EQUEL	exp SAMI_COLON	\n");}
    break;

  case 50:
/* Line 1792 of yacc.c  */
#line 166 "yacc.y"
    {printf("assignment -> eqassign_id 	XOR_AND_EQUEL	exp SAMI_COLON\n");}
    break;

  case 51:
/* Line 1792 of yacc.c  */
#line 169 "yacc.y"
    {printf("eqassign_id -> assign_id\n");}
    break;

  case 52:
/* Line 1792 of yacc.c  */
#line 172 "yacc.y"
    {printf("assign_id -> IDENTIFIER\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 179 "yacc.y"
    {printf("exp -> exp LOGICAL_AND	exp\n");}
    break;

  case 58:
/* Line 1792 of yacc.c  */
#line 180 "yacc.y"
    {printf("exp -> exp LOGICAL_OR	exp\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 184 "yacc.y"
    {printf("exp1 -> exp1 PLUS exp2\n");}
    break;

  case 61:
/* Line 1792 of yacc.c  */
#line 185 "yacc.y"
    {printf("exp1->exp1 MINUS exp2\n");}
    break;

  case 62:
/* Line 1792 of yacc.c  */
#line 186 "yacc.y"
    {printf("exp1-> MINUS exp2\n");}
    break;

  case 63:
/* Line 1792 of yacc.c  */
#line 187 "yacc.y"
    {printf("exp1-> PLUS exp2\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 191 "yacc.y"
    {printf("exp2 -> exp2 MULTIPLY exp3\n");}
    break;

  case 66:
/* Line 1792 of yacc.c  */
#line 192 "yacc.y"
    {printf("exp2 -> exp2 DEVIDE exp3\n");}
    break;

  case 67:
/* Line 1792 of yacc.c  */
#line 193 "yacc.y"
    {printf("exp2 -> exp2 MODULES exp3\n");}
    break;
...
/* Line 1792 of yacc.c  */
#line 197 "yacc.y"
    {printf("exp3 -> LEFT_PARENTHESES exp RIGHT_PARENTHESES\n");}
    break;
